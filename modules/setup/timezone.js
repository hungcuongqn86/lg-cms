...
(function ($, AdminLTE) {
    ...
    function editData(){
        ...
        $.ajax({
            ...
            type: "GET",
            dataType: 'json',
            data: {cmd: 'getTimezoneDataById',
                    id: select_id},
            success: function (data) {
                $("#modal-form-loader").hide();
                if(data && data.result && data.result[0]) {                         
                    $("#txt-form-name").val(data.result[0].S_NAME);
                    $("#txt-form-utc").val(data.result[0].S_UTC);
                    $("#txt-form-code").val(data.result[0].S_CODE);
    ...
    function saveData(){
        ...
        $.ajax({
            ...
            type: "POST",
            dataType: 'json',
            data: {cmd: 'saveTimezoneData',
                id: select_id,
                name: $("#txt-form-name").val(),
                utc:  $("#txt-form-utc").val(),
                code: $("#txt-form-code").val(),
    ...
    var table1 = $("#tb-form").DataTable({
        ...
        'serverSide': true,
        'ajax':{
            url: backendurl + "?cmd=getTimezoneData",
            data: function ( d ) {
